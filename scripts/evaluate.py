...
Usage:
    ...
    python scripts/evaluate.py --checkpoint models/2026-03-30_strategy3_initialTest.pth --test-dir test_data_3cmd --batch-size 64
    python scripts/evaluate.py --checkpoint models/voice_commander.pth --batch-size 64
    ...
    python scripts/evaluate_faster.py --checkpoint continual_experiment_models/2026-04-06_s2_p30.pth --embeddings test_data_3cmd_embeddings.pt
"""
